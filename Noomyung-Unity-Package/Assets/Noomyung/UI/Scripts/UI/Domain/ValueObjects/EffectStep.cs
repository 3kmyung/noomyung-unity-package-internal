...
{
    /// <summary>
    /// 개별 효과 단계를 나타내는 불변 값 객체입니다.
    /// </summary>
    public readonly struct EffectStep : IEquatable<EffectStep>
    {
        ...
        public bool Equals(EffectStep other) =>
            Type == other.Type &&
        ...
        public override bool Equals(object obj) => obj is EffectStep other && Equals(other);
        ...
        public static bool operator ==(EffectStep left, EffectStep right) => left.Equals(right);
