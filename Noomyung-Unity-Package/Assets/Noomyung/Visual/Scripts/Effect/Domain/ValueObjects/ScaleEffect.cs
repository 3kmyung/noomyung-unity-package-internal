...
namespace _3kmyung.Effect.Domain.ValueObjects.Effects
{
    /// <summary>
    /// Scales UI elements with configurable axis masking.
    /// </summary>
    public class ScaleEffect : IEffect
    {
        ...
        public async UniTask ExecuteAsync(IEffectElementPort target, bool reverse, CancellationToken cancellationToken = default)
        {
            var from = From;
            var to = To;
