...
namespace _3kmyung.Authentication.Application
{
    ...
    /// </summary>
    public sealed class SignInWithProviderUseCase : IQuery<(IdentityProviderType provider, string accessToken), string>
    {
        ...
        public async Task<string> ExecuteAsync((IdentityProviderType provider, string accessToken) request, CancellationToken cancellationToken = default)
        {
