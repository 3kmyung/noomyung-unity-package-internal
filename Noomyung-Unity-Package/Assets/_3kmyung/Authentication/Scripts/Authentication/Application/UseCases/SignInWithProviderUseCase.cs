...
namespace _3kmyung.Authentication.Application
{
    ...
    /// </summary>
    public sealed class SignInWithProviderUseCase : IQuery<(AuthenticationProvider provider, string accessToken), string>
    {
        ...
        public async Task<string> ExecuteAsync((AuthenticationProvider provider, string accessToken) request, CancellationToken cancellationToken = default)
        {
