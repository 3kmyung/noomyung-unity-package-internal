...
namespace _3kmyung.Authentication.Application
{
    ...
    /// </summary>
    public sealed class UnlinkProviderUseCase : ICommand<AuthenticationProvider>
    {
        ...
        public async Task ExecuteAsync(AuthenticationProvider request, CancellationToken cancellationToken = default)
        {
